    ...
    <section id="inicio" className="relative h-screen pt-16">
      <div className="absolute inset-0">
        <div className="relative h-full">
          {slides.map((slide, index) => (
            <div key={index} className={`absolute inset-0 ${index === 0 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-1000`}>
      ...
      <div className="relative h-full flex items-center">
        <div className="container mx-auto px-4 text-center text-white">
          ...
          <p className="text-xl md:text-2xl mb-8">Realce sua beleza natural com nossos tratamentos exclusivos</p>
          <a
            href="#servicos"
